    ...
    return (
      <div id="header">
        <div className="row">
          ...
          <div className={cssClass} onClick={()=>window.open('https://github.com/sanger-pathogens/phandango/wiki', '_blank')}>
            <HeaderEntry name="About (wiki)" active={pageName === 'about'}/>
          </div>
          <div className={cssClass} onClick={()=>window.open('https://github.com/sanger-pathogens/phandango', '_blank')}>
