    ...
    return (
      <div className="center" style={{ paddingTop: '15vh' }}>
        ...
        <p style={{ color: '#225ea8' }}>
          <a className="pointer" onClick={()=>window.open('https://github.com/sanger-pathogens/phandango/wiki', '_blank')}>About / Help (GitHub wiki)</a>
          <br/><br/>
          <Link to={"/examples"}>
            <span className="pointer" style={{color: 'rgb(34, 94, 168)'}}>Example Datasets</span>
          </Link>
          <br/><br/>
          <a className="pointer" onClick={()=>window.open('https://github.com/sanger-pathogens/phandango', '_blank')}>Github (source code)</a>
          <br/><br/>
